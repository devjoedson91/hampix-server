...
import { ListByIdController } from './controllers/product/ListByIdController';
...
router.get('/product', isAuthenticated, new ListByIdController().handle);
